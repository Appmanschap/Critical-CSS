...
packages:
  ...
  /asset-resolver@3.0.5:
    resolution: {integrity: sha512-aIGmMndxIi1nGrSwIM+78EhBYD8KSgfmArc33775UJj+13JEAwFjPyZF/Agil8Dmb8PvGjcsIRRhWAro+YxE/w==}
  ...
  /critical@7.1.1:
    resolution: {integrity: sha512-DVNu4QzpQgYhR/9DQGcBn83R8ZKWBVUq9FfUZqOg2QpntHCrwynVynnAWQDPXG87IfO1dYyIiiWbTZtL+ahfPQ==}
    engines: {node: '>=18.18'}
    hasBin: true
    dependencies:
      '@adobe/css-tools': 4.3.3
      ...
      postcss-image-inliner: 7.0.1(postcss@8.4.38)
  ...
  /fg-loadcss@2.1.0:
    resolution: {integrity: sha512-HpvR2uRoKvrYAEwimw+k4Fr2NVHYPfld5Lc/f9uy3mKeUTXhS5urL24XA2rqyq5b2i410EXCLir4Uhsb8J1QaQ==}
    dev: false
  ...
  /inline-critical@12.0.1:
    resolution: {integrity: sha512-qlwleUujGsIzOcAaHZ4C8ptoKI4jgdSvlal1+3UsjJ1WybHf4bY4IpaxnpiDNUTYbLjKKSnLTRPzIikf1bxuWw==}
    engines: {node: '>=18.18'}
    hasBin: true
    dependencies:
      '@adobe/css-tools': 4.3.3
  ...
  /oust@2.0.4:
    resolution: {integrity: sha512-hGFMHndpX0TDdc9bck8bAet7kmVD+lmJnABWYV4RNjjQ+XO2mEhwSK5o15NxAZ9C8qc7rdvqGdnA/0wRP8Ugtg==}
    engines: {node: '>=12'}
    hasBin: true
    dependencies:
      cheerio: 1.0.0-rc.12
  ...
  /penthouse@2.3.3:
    resolution: {integrity: sha512-GnNnF8LYJOpjHvXR2h+HiiwsJFQwBFt3HcdHqPn8PdY12yZhmEASjIldC6NmS9RaCwpnLzFQ4GVAi8WjrIbWLg==}
    engines: {node: '>=8.16.0'}
    dependencies:
      css-mediaquery: 0.1.2
      css-tree: 1.0.0-alpha.28
  ...
  /reaver@2.0.0:
    resolution: {integrity: sha512-VqtmjtpRh3XwBQTLM/KbgV2ERBr4jXwY+8hkcNXNCeGb2uY4KQNigAbHDTLGrDm9tIYiczG4ADI5/1z4teRRjQ==}
    hasBin: true
    dependencies:
      minimist: 1.2.8
    dev: false
  ...
  /rsyncwrapper@3.0.1:
    resolution: {integrity: sha512-fkGmeEJRbKveT/6bBqTVzzHS1wtbGQwL6qnwT/+1AtMAsEV5dX1fSAiOJVZrDOnVsOr2lFl8ga1MZLoHekV3yg==}
    engines: {node: '>=8.1.3'}
    dev: false

...
function loadPage(page, url, timeout, pageLoadSkipTimeout, allowedResponseCode) {
...
async function pruneNonCriticalCssLauncher({
  ...
  return new Promise(async (resolve, reject) => {
    ...
    const loadPagePromise = loadPage(page, url, timeout, pageLoadSkipTimeout, allowedResponseCode); // turn css to formatted selectorlist [NOT BLOCKING]

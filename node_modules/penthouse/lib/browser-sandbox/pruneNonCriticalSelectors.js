...
function pruneNonCriticalSelectors({
  ...
  var h = window.innerHeight; // cache whether elements are above fold,
  ...
  function isElementAboveFold(element) {
    ...
    var aboveFold = element.getBoundingClientRect().top < h; // cache so we dont have to re-query DOM for this value

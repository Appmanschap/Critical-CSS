...
function pruneNonCriticalSelectors({
  ...
  function isElementAboveFold(element) {
    ...
    isElementAboveFoldCache.set(element, aboveFold); // set clear style back to what it was

    element.style.clear = originalClearStyle; // Should not be needed anymore with Chrome Headless:
